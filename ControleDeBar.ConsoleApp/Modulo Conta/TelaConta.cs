...
namespace ControleDeBar.ConsoleApp.Modulo_Conta
{
    public class TelaConta : ITela
    {
        ...
        private RepositorioGarcon repositorioGarcom;

        public TelaConta(
            RepositorioConta repositorioConta,
            RepositorioProduto repositorioProduto,
            RepositorioMesa repositorioMesa,
            RepositorioGarcon repositorioGarcom
        )
        {
        ...
        private Conta ObterDados()
        {
            ...
            Garcon garcomSelecionado = repositorioGarcom.SelecionarRegistroPorId(idGarcom);
        ...
        private void VisualizarGarcons()
        {
            ...
            Garcon[] garcons = repositorioGarcom.SelecionarRegistros();
